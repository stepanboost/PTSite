        ...
        >
          <div className="relative z-10">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-primary-500/10 mb-4 md:mb-6"
              whileHover={{ scale: 1.1 }}
            >
              <Calculator className="w-8 h-8 md:w-10 md:h-10 text-primary-500" />
            </motion.div>
