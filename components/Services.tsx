...
const services = [
  ...
  },
  {
    ...
    icon: Globe,
    title: 'Русификация',
    description: 'Полная адаптация автомобиля под российские стандарты: русификация интерфейса, установка приложений, настройка навигации.',
    bullets: [
      'Русификация интерфейса',
      'Установка приложений',
      'Навигация РФ',
      'Локальная SIM (установка/пайка при необходимости)',
      'Голосовой помощник',
    ],
  },
  {
  ...
  },
  {
    ...
    icon: Wrench,
    title: 'Сервис',
    description: 'Техническое обслуживание и ремонт: диагностика, электрика, подвеска, HV-системы, обновление ПО, запчасти — всё в одном месте.',
    bullets: [
      'Диагностика',
      'Обслуживание EV/гибридных систем (HV)',
      'Обновление ПО',
      'Кузовной и малярный ремонт',
  ...
  },
  {
    ...
    icon: Shield,
    title: 'Гарантия',
    description: 'Гарантия на автомобили и выполненные работы. Долгосрочное сопровождение и поддержка.',
    bullets: [
      'Гарантия на автомобили и выполненные работы',
